...
effective_avail_m = avail_m + (safe_area_m if using_1_2_factor else 0.0)
avail_ft = effective_avail_m / 0.3048

st.markdown("### Available Runway Length")
c1, c2 = st.columns(2)
c1.write(f"**{effective_avail_m:.0f} m**" + (" (includes Safe Area)" if using_1_2_factor and safe_area_m > 0 else ""))
